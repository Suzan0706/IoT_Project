...
print('Tags:', dataset_tags(d))
print('Stars:', quality_stars(d.quality_score))
print('Date range:', date_range(d))

with open(r'C:\Users\HomePC\AppData\Local\Temp\kilo\filter_test.txt', 'w', encoding='utf-8') as f:
